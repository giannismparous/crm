  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={onToggle}
        title={title}
        aria-label={t("chat.expandNamed", {
          title,
          state: active ? t("chat.expandOpen") : t("chat.expandClosed"),
        })}
        aria-pressed={active}
      ...
      >
        ...
        {unreadCount > 0 && !active && (
          <span
            ...
            aria-label={t("chat.unreadCount", { count: unreadCount })}
          >
      ...
      <button
        ...
        title={t("chat.close")}
        aria-label={t("chat.closeNamed", { title })}
